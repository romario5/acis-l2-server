...
public class Olympiad
{
	...
	protected synchronized void addWeeklyPoints()
	{
		...
		{
			currentPoints = set.getInteger(POINTS);
			currentPoints += Config.OLY_WEEKLY_POINTS;
			set.set(POINTS, currentPoints);
		}
	}
	...
	/**
	 * @param charId : The noble objectId.
	 * @param set : The {@link StatSet} to set.
	 * @return The old {@link StatSet} if the noble is already present, or null otherwise.
	 */
	protected StatSet addNobleStats(int charId, StatSet set)
	{
		return _nobles.put(charId, set);
	}
