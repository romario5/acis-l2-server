...
public class Q221_TestimonyOfProsperity extends SecondClassQuest
{
	...
	public String onKill(Npc npc, Creature killer)
	{
		...
		switch (npc.getNpcId())
		{
			...
			case MARSH_STAKATO:
				if (cond == 7 && dropItems(player, STAKATO_SHELL, 1, 20, 200000) && player.getInventory().getItemCount(TOAD_LORD_SAC) + player.getInventory().getItemCount(SPIDER_THORN) == 20)
					st.setCond(8);
				break;
			
			case MARSH_STAKATO_WORKER:
				if (cond == 7 && dropItems(player, STAKATO_SHELL, 1, 20, 300000) && player.getInventory().getItemCount(TOAD_LORD_SAC) + player.getInventory().getItemCount(SPIDER_THORN) == 20)
					st.setCond(8);
				break;
			
			case MARSH_STAKATO_SOLDIER:
				if (cond == 7 && dropItems(player, STAKATO_SHELL, 1, 20, 500000) && player.getInventory().getItemCount(TOAD_LORD_SAC) + player.getInventory().getItemCount(SPIDER_THORN) == 20)
					st.setCond(8);
				break;
			
			case MARSH_STAKATO_DRONE:
				if (cond == 7 && dropItems(player, STAKATO_SHELL, 1, 20, 600000) && player.getInventory().getItemCount(TOAD_LORD_SAC) + player.getInventory().getItemCount(SPIDER_THORN) == 20)
					st.setCond(8);
				break;
			
			case TOAD_LORD:
				if (cond == 7 && dropItems(player, TOAD_LORD_SAC, 1, 10, 200000) && player.getInventory().getItemCount(STAKATO_SHELL) + player.getInventory().getItemCount(SPIDER_THORN) == 30)
					st.setCond(8);
				break;
			
			case MARSH_SPIDER:
				if (cond == 7 && dropItems(player, SPIDER_THORN, 1, 10, 200000) && player.getInventory().getItemCount(STAKATO_SHELL) + player.getInventory().getItemCount(TOAD_LORD_SAC) == 30)
					st.setCond(8);
				break;
		}
