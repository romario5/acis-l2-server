...
public class Q419_GetAPet extends Quest
{
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		{
			st.set("progress", String.valueOf(st.getInteger("progress") | 1));
			if (st.getInteger("progress") == 7)
				playSound(player, SOUND_MIDDLE);
		}
		else if (event.equalsIgnoreCase("30072-02.htm"))
		{
			st.set("progress", String.valueOf(st.getInteger("progress") | 2));
			if (st.getInteger("progress") == 7)
				playSound(player, SOUND_MIDDLE);
		}
		else if (event.equalsIgnoreCase("30091-02.htm"))
		{
			st.set("progress", String.valueOf(st.getInteger("progress") | 4));
			if (st.getInteger("progress") == 7)
				playSound(player, SOUND_MIDDLE);
		}
		...
		{
			st.set("wrong", String.valueOf(st.getInteger("wrong") + 1));
			return checkQuestions(player, st);
		}
		else if (event.equalsIgnoreCase("right"))
		{
			st.set("correct", String.valueOf(st.getInteger("correct") + 1));
			return checkQuestions(player, st);
		}
