...
public class Q619_RelicsOfTheOldEmpire extends Quest
{
	...
	public String onKill(Npc npc, Creature killer)
	{
		...
		{
			dropItems(player, BROKEN_RELIC_PART, 1, 0, IMPERIAL_TOMB_DROPLIST.get(npcId));
			
			// only Imperial Tomb monsters drop Entrance Pass to the Sepulcher, always 1:30 (3,33%)
			dropItems(player, ENTRANCE_PASS_TO_THE_SEPULCHER, 1, 0, 33333);
		}
		else
			dropItems(player, BROKEN_RELIC_PART, 1, 0, FOUR_SEPULCHERS_DROPLIST.get(npcId));
